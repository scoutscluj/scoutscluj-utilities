...
FINANCE_GMAIL_CLIENT_ID="$(secret_value "${APP_SECRET_JSON}" FINANCE_GMAIL_CLIENT_ID)"
FINANCE_GMAIL_CLIENT_SECRET="$(secret_value "${APP_SECRET_JSON}" FINANCE_GMAIL_CLIENT_SECRET)"
FINANCE_GMAIL_REFRESH_TOKEN="$(secret_value "${APP_SECRET_JSON}" FINANCE_GMAIL_REFRESH_TOKEN)"
FINANCE_GMAIL_SENDER_EMAIL="$(secret_value "${APP_SECRET_JSON}" FINANCE_GMAIL_SENDER_EMAIL)"
KEEZ_DOCUMENT_EMAIL_EXPECTED_SENDER="$(secret_value "${APP_SECRET_JSON}" KEEZ_DOCUMENT_EMAIL_EXPECTED_SENDER)"
KEEZ_DOCUMENT_EMAIL_RECIPIENT="$(secret_value "${APP_SECRET_JSON}" KEEZ_DOCUMENT_EMAIL_RECIPIENT)"
...
write_env_value "${API_ENV_FILE}" FINANCE_GMAIL_CLIENT_ID "${FINANCE_GMAIL_CLIENT_ID}"
write_env_value "${API_ENV_FILE}" FINANCE_GMAIL_CLIENT_SECRET "${FINANCE_GMAIL_CLIENT_SECRET}"
write_env_value "${API_ENV_FILE}" FINANCE_GMAIL_REFRESH_TOKEN "${FINANCE_GMAIL_REFRESH_TOKEN}"
write_env_value "${API_ENV_FILE}" FINANCE_GMAIL_SENDER_EMAIL "${FINANCE_GMAIL_SENDER_EMAIL}"
write_env_value "${API_ENV_FILE}" KEEZ_DOCUMENT_EMAIL_EXPECTED_SENDER "${KEEZ_DOCUMENT_EMAIL_EXPECTED_SENDER}"
write_env_value "${API_ENV_FILE}" KEEZ_DOCUMENT_EMAIL_RECIPIENT "${KEEZ_DOCUMENT_EMAIL_RECIPIENT}"
